    ...
    var body: some View {
        GeometryReader { proxy in
            ...
            ZStack {
                ...
                LinearGradient(
                    colors: [
                        AppColorsPremium.bgElevated,
                        AppColorsPremium.bgBase,
                        AppColorsPremium.bgDeep
                    ],
                ...
                Circle()
                    .fill(AppColorsPremium.auroraBlue.opacity(0.28))
                    .frame(width: w * 0.85)
                    .blur(radius: 100)
                ...
                Circle()
                    .fill(AppColorsPremium.auroraTeal.opacity(0.20))
                    .frame(width: w * 0.7)
                    .blur(radius: 110)
                ...
                // Violet-Aurora (unten)
                Circle()
                    .fill(AppColorsPremium.auroraViolet.opacity(0.18))
                    .frame(width: w * 0.95)
                    .blur(radius: 120)
